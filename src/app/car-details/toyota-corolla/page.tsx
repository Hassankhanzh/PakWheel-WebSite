...
const ToyotaCorollaDetails: React.FC = () => {
    const router = useRouter(); // Initialize useRouter for navigation

    const handleMoreDetails = () => {
        router.push('/car-details/toyota-corolla/more-details'); // Navigate to More Details page for Toyota Corolla
    };
    const handleMakePayment = () => {
        router.push('/car-details/toyota-corolla/checkout'); // Navigate to More Details page for Toyota Corolla
    };
    return (
        <div className="container mx-auto px-4 py-8 bg-gray-100">
            <h1 className="text-3xl font-bold text-center mb-6 underline">
                Toyota Corolla 2024 - Price, Images, Reviews &<br /> Specs
            </h1>
            
            <div className="flex justify-center mb-4">
                <Image 
                    src="/Corolla-X-Cars-Cropped-Pictures-for-Website.jpg"  // Image from the public folder
                    alt="Toyota Corolla" 
...
export default ToyotaCorollaDetails;

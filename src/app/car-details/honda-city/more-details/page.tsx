...
const HondaCityMoreDetails: React.FC = () => {
    ...
    return (
        <div className="bg-gray-100 min-h-screen py-10 px-4">
            ...
            <h1 className="text-4xl font-bold text-center underline mb-8">
                Honda City 2024 - Price in Pakistan, Images, Reviews &<br /> Specs
            </h1>
            
            {/* Centered Image */}
            <div className="flex justify-center mb-6">
                <Image 
                    src="/Honda_City_Front.jpg" // Placeholder for Toyota Corolla image
                    alt="Honda City" 
                    width={500} 
                    height={400} 
...
export default HondaCityMoreDetails;

...
const HondaCivicDetails: React.FC = () => {
    const router = useRouter(); // Initialize useRouter for navigation

    const handleMoreDetails = () => {
        router.push('/car-details/honda-civic/more-details'); // Navigate to More Details page for Honda City
    };
    const handleMakePayment = () => {
        router.push('/car-details/honda-civic/checkout'); // Navigate to More Details page for Honda City
    };
    return (
        <div className="container mx-auto px-4 py-8 bg-gray-100">
            <h1 className="text-3xl font-bold text-center mb-6 underline">
                Honda Civic 2024 - Price, Images, Reviews &<br /> Specs
            </h1>
            
            <div className="flex justify-center mb-4">
                <Image 
                    src="/honda civic.jpg"  // Image from the public folder
                    alt="Honda Civic" 
